...
public class JobItemsAdapter extends RecyclerView.Adapter<JobItemsAdapter.MedicalViewHolder> {

    private List<MedicalPojo> medicalPojos ;

    private Context mcontext;
    public JobItemsAdapter(List<MedicalPojo> medicalPojos, Context context) {
